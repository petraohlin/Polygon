// Source: Sann-Remy, http://srchea.com/experimenting-with-web-audio-api-three-js-webgl
var context;
var source, sourceJs;
var analyser;
var buffer;
var url = 'music/soundtrack.ogg';
var array = new Array();
var boost = 0;
...
request.onload = function() {
	context.decodeAudioData(
		...
		function(buffer) {
			...
			$('#soundcloudimg').css('top', ($(window).height()/1.17)  + 'px');
			$('#soundcloudimg').css('left', ($(window).width()/1.13) + 'px');
			$('#play').fadeIn();
		},
		function(error) {
